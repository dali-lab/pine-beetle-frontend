        ...
        <div className="flex-container" id="model-input-area">
            <div className="flex-item-left container" id="timeline">
                <div id="timeline-area">
                    <ol>
                        <li>
                            <h3 className="timeline-title">{this.props.dataControllerState.userFilters.predictiveModelDate - 2}</h3>
                        ...
                        <li id="special-li-timeline">
                            <h3 className="timeline-title">{this.props.dataControllerState.userFilters.predictiveModelDate - 1}</h3>
                            <span className="point"></span>
                            <div>
                                <center>
                        ...
                        <li id="special-li-timeline">
                            <h3 className="timeline-title">{"Spring " + this.props.dataControllerState.userFilters.predictiveModelDate}</h3>
                            <span className="point"></span>
                            <div>
                                <center>
