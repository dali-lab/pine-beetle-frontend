...
export {
  ...
  DOWNLOAD_DATA_ROUTES, LOCAL_STORAGE_KEYS, MAP_SOURCES, MAP_SOURCE_NAME,
  MAP_TITLES, MIN_WIDTH_THRESHOLD, RESOURCE_LOCAL_URLS, RESOURCE_REMOTE_URLS,
  RESOURCE_ROUTES, ROUTES, SERVER_ENDPOINTS, SOURCE_LAYERS, STATE_VECTOR_LAYER,
  VECTOR_LAYER, VIDEO_URL, getAutomationServerUrl, getServerUrl, getYearRange,
  stateAbbrevToStateId, stateAbbrevToStateName, stateAbbrevToZoomLevel,
  stateNameToAbbrev,
};
